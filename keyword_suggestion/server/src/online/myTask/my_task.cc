...
namespace keyword_suggestion
{
    ...
    MyTask::MyTask(const string &queryWord, const TcpPtr &pConn, const DictPtr_cn &dictCn, const DictPtr_en &dictEn)
        : _queryWord(queryWord), _pConn(pConn), _pDictCn(dictCn), _pDictEn(dictEn)
    {
    }
